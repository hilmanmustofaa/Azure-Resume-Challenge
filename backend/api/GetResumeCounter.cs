...
namespace Company.Function
{
    public static class GetResumeCounter
    {
        ...
        public static HttpResponseMessage Run(
            ...
            [CosmosDB(databaseName:"azureresume", collectionName:"Counter", ConnectionStringSetting = "AzureResumeConnectionString", Id = "1", PartitionKey = "1")] Counter updatedCounter,
